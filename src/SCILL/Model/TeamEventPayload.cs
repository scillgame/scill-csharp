...
namespace SCILL.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TeamEventPayload :  IEquatable<TeamEventPayload>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TeamEventPayload" /> class.
        /// </summary>
        ...
        public TeamEventPayload(string userId = default(string), string teamId = default(string), string sessionId = default(string), string eventName = default(string), string eventType = "single", EventMetaData metaData = default(EventMetaData))
        {
            this.user_id = userId;
            this.team_id = teamId;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TeamEventPayload {\n");
        ...
        {
            return this.Equals(input as TeamEventPayload);
        }

        /// <summary>
        /// Returns true if TeamEventPayload instances are equal
        /// </summary>
        /// <param name="input">Instance of TeamEventPayload to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TeamEventPayload input)
        {
            if (input == null)
                return false;
