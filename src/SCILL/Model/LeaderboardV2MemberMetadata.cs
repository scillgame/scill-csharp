...
namespace SCILL.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class LeaderboardV2MemberMetadata :  IEquatable<LeaderboardV2MemberMetadata>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LeaderboardV2MemberMetadata" /> class.
        /// </summary>
        ...
        public LeaderboardV2MemberMetadata(string key = default(string), bool? ranked = default(bool?), int? score = default(int?), int? rank = default(int?))
        {
            this.key = key;
            this.ranked = ranked;
            this.score = score;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LeaderboardV2MemberMetadata {\n");
        ...
        {
            return this.Equals(input as LeaderboardV2MemberMetadata);
        }

        /// <summary>
        /// Returns true if LeaderboardV2MemberMetadata instances are equal
        /// </summary>
        /// <param name="input">Instance of LeaderboardV2MemberMetadata to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LeaderboardV2MemberMetadata input)
        {
            if (input == null)
                return false;
