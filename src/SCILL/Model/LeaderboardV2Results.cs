...
namespace SCILL.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class LeaderboardV2Results :  IEquatable<LeaderboardV2Results>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LeaderboardV2Results" /> class.
        /// </summary>
        ...
        /// <param name="leaderboardResultsByMemberType">leaderboardResultsByMemberType.</param>
        public LeaderboardV2Results(string leaderboardId = default(string), string leaderboardName = default(string), bool? leaderboardSortOrderAscending = default(bool?), LeaderboardV2ResultsLeaderboardResultsByMemberType leaderboardResultsByMemberType = default(LeaderboardV2ResultsLeaderboardResultsByMemberType))
        {
            ...
            this.leaderboard_results_by_member_type = leaderboardResultsByMemberType;
        }
        ...
        /// <summary>
        /// Gets or Sets leaderboard_results_by_member_type
        /// </summary>
        [DataMember(Name="leaderboard_results_by_member_type", EmitDefaultValue=false)]
        public LeaderboardV2ResultsLeaderboardResultsByMemberType leaderboard_results_by_member_type { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LeaderboardV2Results {\n");
            ...
            sb.Append("  leaderboard_results_by_member_type: ").Append(leaderboard_results_by_member_type).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as LeaderboardV2Results);
        }

        /// <summary>
        /// Returns true if LeaderboardV2Results instances are equal
        /// </summary>
        /// <param name="input">Instance of LeaderboardV2Results to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LeaderboardV2Results input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.leaderboard_results_by_member_type == input.leaderboard_results_by_member_type ||
                    (this.leaderboard_results_by_member_type != null &&
                    this.leaderboard_results_by_member_type.Equals(input.leaderboard_results_by_member_type))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.leaderboard_results_by_member_type != null)
                    hashCode = hashCode * 59 + this.leaderboard_results_by_member_type.GetHashCode();
                return hashCode;
            }
        }
